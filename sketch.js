...
if(keyCode === LEFT_ARROW){
    ...
    cat2.addAnimation("runningCat", cat3);
    cat2.changeAnimation("runningCat");

    mouse2.addAnimation("runningMouse", mouse3);

    mouse2.frameDelay = 20;

    mouse2.changeAnimation("runningMouse");
  }
